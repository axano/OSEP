...
namespace pipi
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            CreateProcessWithTokenW(hSystemToken, (uint) LogonFlags.WithProfile, null, "C:\\Windows\\System32\\cmd.exe /c " + command, (uint)CreationFlags.UnicodeEnvironment, env, sbSystemDir.ToString(), ref si, out pi);
        }
    }
}
